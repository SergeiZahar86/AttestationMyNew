...
public class car_t implements org.apache.thrift.TBase<car_t, car_t._Fields>, java.io.Serializable, Cloneable, Comparable<car_t> {
  ...
  private static final org.apache.thrift.protocol.TField ATT_CODE_FIELD_DESC = new org.apache.thrift.protocol.TField("att_code", org.apache.thrift.protocol.TType.I32, (short)4);
  private static final org.apache.thrift.protocol.TField TARA_FIELD_DESC = new org.apache.thrift.protocol.TField("tara", org.apache.thrift.protocol.TType.DOUBLE, (short)5);
  private static final org.apache.thrift.protocol.TField ZONE_E_FIELD_DESC = new org.apache.thrift.protocol.TField("zone_e", org.apache.thrift.protocol.TType.I32, (short)6);
  private static final org.apache.thrift.protocol.TField CAUSE_ID_FIELD_DESC = new org.apache.thrift.protocol.TField("cause_id", org.apache.thrift.protocol.TType.I32, (short)7);
  private static final org.apache.thrift.protocol.TField CAUSE_NAME_FIELD_DESC = new org.apache.thrift.protocol.TField("cause_name", org.apache.thrift.protocol.TType.STRING, (short)8);
  private static final org.apache.thrift.protocol.TField CARRYING_FIELD_DESC = new org.apache.thrift.protocol.TField("carrying", org.apache.thrift.protocol.TType.DOUBLE, (short)9);
  private static final org.apache.thrift.protocol.TField ATT_TIME_FIELD_DESC = new org.apache.thrift.protocol.TField("att_time", org.apache.thrift.protocol.TType.STRING, (short)10);
  ...
  public @org.apache.thrift.annotation.Nullable java.lang.String cause_name; // required
  public double carrying; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    NUM((short)3, "num"),
    ATT_CODE((short)4, "att_code"),
    TARA((short)5, "tara"),
    ZONE_E((short)6, "zone_e"),
    CAUSE_ID((short)7, "cause_id"),
    CAUSE_NAME((short)8, "cause_name"),
    CARRYING((short)9, "carrying"),
    ATT_TIME((short)10, "att_time");
  ...
  private static final int __ATT_CODE_ISSET_ID = 2;
  private static final int __TARA_ISSET_ID = 3;
  private static final int __ZONE_E_ISSET_ID = 4;
  private static final int __CAUSE_ID_ISSET_ID = 5;
  private static final int __CARRYING_ISSET_ID = 6;
  ...
  static {
    ...
    tmpMap.put(_Fields.CAUSE_ID, new org.apache.thrift.meta_data.FieldMetaData("cause_id", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I32        , "int")));
    tmpMap.put(_Fields.CAUSE_NAME, new org.apache.thrift.meta_data.FieldMetaData("cause_name", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.CARRYING, new org.apache.thrift.meta_data.FieldMetaData("carrying", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.DOUBLE)));
  ...
  public car_t(car_t other) {
    ...
    if (other.isSetCause_name()) {
      this.cause_name = other.cause_name;
    }
    this.carrying = other.carrying;
  ...
  public void clear() {
    ...
    this.cause_id = 0;
    this.cause_name = null;
    setCarryingIsSet(false);
    this.carrying = 0.0;
    this.att_time = null;
  }
  ...
  public car_t setPart_id(int part_id) {
    this.part_id = part_id;
    setPart_idIsSet(true);
    return this;
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.lang.String getCause_name() {
    return this.cause_name;
  }

  public car_t setCause_name(@org.apache.thrift.annotation.Nullable java.lang.String cause_name) {
    this.cause_name = cause_name;
    return this;
  }

  public void unsetCause_name() {
    this.cause_name = null;
  }

  /** Returns true if field cause_name is set (has been assigned a value) and false otherwise */
  public boolean isSetCause_name() {
    return this.cause_name != null;
  }

  public void setCause_nameIsSet(boolean value) {
    if (!value) {
      this.cause_name = null;
    }
  }
  ...
  public car_t setCarrying(double carrying) {
    this.carrying = carrying;
    setCarryingIsSet(true);
    return this;
  }
  ...
  public void unsetCarrying() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __CARRYING_ISSET_ID);
  }

  /** Returns true if field carrying is set (has been assigned a value) and false otherwise */
  public boolean isSetCarrying() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __CARRYING_ISSET_ID);
  }

  public void setCarryingIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __CARRYING_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case CAUSE_NAME:
      if (value == null) {
        ...
        setCause_name((java.lang.String)value);
      }
      break;
    ...
    case CARRYING:
      if (value == null) {
        ...
        setCarrying((java.lang.Double)value);
      }
      break;
  ...
  public boolean isSet(_Fields field) {
    ...
    case CAUSE_NAME:
      return isSetCause_name();
    case CARRYING:
      return isSetCarrying();
    case ATT_TIME:
  ...
  public boolean equals(car_t that) {
    ...
    boolean this_present_cause_name = true && this.isSetCause_name();
    boolean that_present_cause_name = true && that.isSetCause_name();
    if (this_present_cause_name || that_present_cause_name) {
      if (!(this_present_cause_name && that_present_cause_name))
        return false;
      if (!this.cause_name.equals(that.cause_name))
        return false;
    }

    boolean this_present_carrying = true;
    boolean that_present_carrying = true;
    if (this_present_carrying || that_present_carrying) {
      if (!(this_present_carrying && that_present_carrying))
        return false;
      if (this.carrying != that.carrying)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetCause_name()) ? 131071 : 524287);
    if (isSetCause_name())
      hashCode = hashCode * 8191 + cause_name.hashCode();

    hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(carrying);
  ...
  public int compareTo(car_t other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetCause_name()).compareTo(other.isSetCause_name());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCause_name()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.cause_name, other.cause_name);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = java.lang.Boolean.valueOf(isSetCarrying()).compareTo(other.isSetCarrying());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCarrying()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.carrying, other.carrying);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (this.cause_name == null) {
      sb.append("null");
    } else {
      sb.append(this.cause_name);
    }
    first = false;
    if (!first) sb.append(", ");
    sb.append("carrying:");
    sb.append(this.carrying);
    first = false;
    if (!first) sb.append(", ");
    sb.append("att_time:");
  ...
  private static class car_tStandardScheme extends org.apache.thrift.scheme.StandardScheme<car_t> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, car_t struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 8: // CAUSE_NAME
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.cause_name = iprot.readString();
              struct.setCause_nameIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          case 9: // CARRYING
            if (schemeField.type == org.apache.thrift.protocol.TType.DOUBLE) {
              struct.carrying = iprot.readDouble();
              struct.setCarryingIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, car_t struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      if (struct.cause_name != null) {
        oprot.writeFieldBegin(CAUSE_NAME_FIELD_DESC);
        oprot.writeString(struct.cause_name);
        oprot.writeFieldEnd();
      }
      oprot.writeFieldBegin(CARRYING_FIELD_DESC);
      oprot.writeDouble(struct.carrying);
      oprot.writeFieldEnd();
  ...
  private static class car_tTupleScheme extends org.apache.thrift.scheme.TupleScheme<car_t> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, car_t struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetCause_name()) {
        optionals.set(7);
      }
      if (struct.isSetCarrying()) {
        optionals.set(8);
      }
