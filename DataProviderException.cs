...
[Serializable]
#endif
public partial class DataProviderException : TException, TBase
{
  ...
  public void Write(TProtocol oprot) {
    ...
    try
    {
      TStruct struc = new TStruct("DataProviderException");
  ...
  public override string ToString() {
    StringBuilder __sb = new StringBuilder("DataProviderException(");
    bool __first = true;
    if (Message != null && __isset.message) {
